...
namespace LegitProfiler
{
   ...
   void ProfilerGraph::RenderLegend(ImDrawList * drawList, glm::vec2 legendPos, glm::vec2 legendSize, size_t frameIndexOffset)
   {
      ...
      for (size_t taskIndex = 0; taskIndex < currFrame.tasks.size(); taskIndex++)
      {
         ...
         uint32_t textColor = useColoredLegendText ? task.color : LegitProfiler::Colors::imguiText;// task.color;
